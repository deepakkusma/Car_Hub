...
// Add to favorites
router.post("/:vehicleId", requireAuth, async (req: Request, res: Response) => {
    try {
...
router.delete("/:vehicleId", requireAuth, async (req: Request, res: Response) => {
    try {
        const { vehicleId } = req.params;
...
router.get("/:vehicleId/check", requireAuth, async (req: Request, res: Response) => {
    try {
        const { vehicleId } = req.params;
